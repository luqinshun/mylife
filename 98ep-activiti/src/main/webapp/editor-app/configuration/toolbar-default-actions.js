...
KISBPM.TOOLBAR = {
    ACTIONS: {
        ...
        closeEditor: function(services) {
    		...
    		var modelStr = url.substr(url.indexOf("?"));
    		var arr = modelStr.split("=");
    		var modelId = arr[1];
    		var tenantId = getTenantId(modelId);
    		window.location.href = "userModel?a=" + tenantId;
        },
...
function getTenantId(modelId){
	var tenantId='';
	jQuery.ajax({
		type: 'get',
		async:false,
		url: 'model/getTenantId/' + modelId,
